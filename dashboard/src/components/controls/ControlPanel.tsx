...
export function ControlPanel() {
  const { state, dispatch, datasets, selectedDataset, availableProducts, tradeFilterSupport, importDataset } = useDashboard();
  ...
  return (
    <div className="stack">
      ...
      <Panel title={isSubmissionMode ? "Backtest Focus" : "Market Focus"}>
        <label className="field">
          <span>{isSubmissionMode ? "Performance Item" : "Product"}</span>
          <select
      ...
      {isSubmissionMode ? (
        <Panel title="Backtester View">
          <p className="future-filter-copy">
            Submission logs and replay outputs use the backtester layout automatically. This mode emphasizes equity,
            Sharpe-like metrics, drawdown, per-item contribution, and the trade tape.
          </p>
          <p className="future-filter-copy">
        ...
        <>
          ...
          <Panel title="Future Filters">
            ...
            <div className="future-filter-copy">
              Reserved for overlays, log syncing, normalization, and advanced performance controls.
            </div>
          </Panel>
        </>
      )}
